...
public class Source {
    ...
    public static void CheckPNRstatus(Ticket[] tickets){
        ...
        for(Ticket t:tickets){
            if (t.getPNR() == pnrNum) {
                System.out.println("ticket status: "+(t.getStatus() ? "Booked" : "Cancelled"));
                count = 1;
            }
        }
        if (count == 0){
    ...
    public static void main(String[] args){
        ...
        switch(choice){
            case 1: BookTicket(flights, tickets);
                    break;
            case 2: CheckSeatAvailability(flights);
                    break;
            case 3: CheckPNRstatus(tickets);
                    break;
            case 4: PrintTicket(tickets);
                    break;
            case 5: CancelTicket(tickets);
                    break;
            //case 6: UpdateDetails(tickets);
              //      break;
            //case 6: exit();
              //      System.exit(0);
